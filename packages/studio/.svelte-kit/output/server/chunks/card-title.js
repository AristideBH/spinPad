import { O as attributes, Q as clsx, P as bind_props } from "./renderer.js";
...
function Card_title($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div${attributes({
      ...
      class: clsx(cn("font-heading text-base leading-snug font-medium group-data-[size=sm]/card:text-sm", className)),
      ...restProps
    })}>`);
    children?.($$renderer2);
    $$renderer2.push(`<!----></div>`);
