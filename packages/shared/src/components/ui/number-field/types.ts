...
import type { ButtonProps } from '$shared/components/button.svelte';
import type { UseRampOptions } from '$shared/hooks/use-ramp.svelte';
import type { WithElementRef } from '$shared/utils';
