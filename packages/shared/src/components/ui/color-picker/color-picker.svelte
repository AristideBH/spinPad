<script lang="ts">
  ...
  import * as ButtonGroup from '$shared/components/ui/button-group';
...
<div class={cn('flex w-[350px] flex-col gap-3 p-3 border rounded-lg shadow-sm bg-popover', className)}>
  <div
    bind:this={sbRef}
    class="relative w-full h-56 overflow-hidden rounded-md shadow-sm cursor-crosshair touch-none"
  ...
  >
    <div class="absolute inset-0 pointer-events-none bg-gradient-to-r from-white to-transparent"></div>
    <div class="absolute inset-0 pointer-events-none bg-gradient-to-t from-black to-transparent"></div>
    <div
      class="absolute w-3 h-3 -translate-x-1/2 -translate-y-1/2 border-2 border-white rounded-full shadow-sm pointer-events-none ring-1 ring-black/20"
      style:left={`${s}%`}
      style:top={`${100 - v}%`}
    ></div>
  </div>
  ...
  <div class="flex items-center gap-3">
    ...
    <div class="flex flex-col justify-center flex-1 gap-3">
      <div
        bind:this={hueRef}
        class="relative w-full h-3 rounded-full shadow-sm cursor-pointer ring-1 ring-black/5 touch-none"
      ...
      >
        <div
          class="absolute w-3 h-3 -translate-x-1/2 -translate-y-1/2 bg-white rounded-full pointer-events-none top-1/2"
