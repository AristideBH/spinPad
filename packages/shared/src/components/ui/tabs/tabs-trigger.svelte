...
<TabsPrimitive.Trigger
	...
	class={cn(
		...
		"data-active:bg-primary dark:data-active:text-background dark:data-active:border-input dark:data-active:bg-foreground data-active:text-background dark:hover:data-active:text-muted",
