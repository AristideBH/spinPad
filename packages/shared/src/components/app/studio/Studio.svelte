<script lang="ts">
  ...
  import { configState, loadConfig, saveConfig, hasPendingSave } from '$shared/store/config.svelte.js';
  ...
  // Ctrl+Z/Ctrl+Y undo/redo shortcut disabled for now (toolbar buttons still work).
</script>
...
<article
  class="@container/main [will-change:opacity] flex flex-col items-stretch w-full max-w-5xl gap-6 px-4 py-4 mx-auto transition-all duration-500 ease-in-out"
