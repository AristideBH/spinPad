<script lang="ts" module>
	...
	export { type ButtonSize, type ButtonVariant } from '$shared/components/ui/button';
</script>

<script lang="ts">
	import { Button, type ButtonProps as ButtonPrimitiveProps } from '$shared/components/ui/button';
