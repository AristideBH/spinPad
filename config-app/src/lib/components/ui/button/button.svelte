  ...
  export const buttonVariants = tv({
    ...
    variants: {
      variant: {
        ...
        outline:
          "  hover:bg-muted hover:dark:bg-input/30 dark:border-input dark:hover:bg-input/50 aria-expanded:bg-muted aria-expanded:",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 aria-expanded:bg-secondary aria-expanded:text-secondary-foreground",
        ghost:
          "hover:bg-muted hover:dark:hover:bg-muted/50 aria-expanded:bg-muted aria-expanded:",
        destructive:
