// ═══════════════════════════════════════════════════════════════
//  action-types.js — Source de vérité des types d'actions
//
 ...
 * @param {number} type  - nibble 0–15
 * @param {number} value - 12 bits de valeur (0–4095)
 * @returns {number}
 */
 ...
 * @returns {number}
 */
export function getActionType(actionValue) {
 ...
 * @returns {number}
 */
export function getActionValue(actionValue) {
