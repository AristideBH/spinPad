// ═══════════════════════════════════════════════════════════════
//  keycodes.js — Table des keycodes disponibles (source de vérité)
//
...
const { ACTION_TYPE_KC, ACTION_TYPE_MOD, ACTION_TYPE_LAYER_MO,
        ACTION_TYPE_LAYER_TG, ACTION_TYPE_LAYER_TO,
        ACTION_TYPE_MEDIA, ACTION_TYPE_SPECIAL } = ACTION_TYPES;

const { MEDIA_VOL_UP, MEDIA_VOL_DN, MEDIA_MUTE, MEDIA_PLAY,
        MEDIA_NEXT, MEDIA_PREV, MEDIA_SCRL_UP, MEDIA_SCRL_DN,
        MEDIA_ZOOM_IN, MEDIA_ZOOM_OUT, MEDIA_SCRL_LEFT, MEDIA_SCRL_RIGHT } = MEDIA_CODES;

const { SPECIAL_BLE_SWITCH, SPECIAL_ORIENT_CW, SPECIAL_ORIENT_CCW,
        SPECIAL_LED_BRIGHT_UP, SPECIAL_LED_BRIGHT_DN, SPECIAL_STUDIO_MODE } = SPECIAL_CODES;
